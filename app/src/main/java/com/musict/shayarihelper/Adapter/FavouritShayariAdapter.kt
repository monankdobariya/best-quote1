...
class FavouritShayariAdapter(var likefv:(Int,Int) -> Unit) : RecyclerView.Adapter<FavouritShayariAdapter.myViewHolder>() {
    ...
    class myViewHolder(itemview : View) : RecyclerView.ViewHolder(itemview) {
        ...
        var heartlike:ImageView=itemview.findViewById(R.id.heartlike)
    ...
    override fun onBindViewHolder(holder:myViewHolder, position: Int) {
        ...
        holder.txtfv.text=fvlist[position].quotes
            ...
            holder.heartlike.setImageResource(R.drawable.redlike)

        holder.heartlike.setOnClickListener {

            likefv.invoke(fvlist[position].id,0)
            holder.heartlike.setImageResource(R.drawable.like1)
